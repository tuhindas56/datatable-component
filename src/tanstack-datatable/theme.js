...
const theme = createTheme({
      ...
      styleOverrides: {
        root: {
          ...
          "&.ts-dt-add-sort-filter-button": {
            background: "var(--ts-dt-btn-bg, var(--primary))",
            color: "white",
            "&:hover": {
              background: "var(--ts-dt-btn-hover-bg, var(--primary))",
            },
          },

          "&.ts-dt-add-sort-filter-button:disabled": {
            background: "var(--ts-dt-btn-disabled-bg, #8b8b8b)",
            color: "var(--ts-dt-btn-disabled-color, #f7f7f7)",
          },
          ...
          "&.ts-dt-dynamic-filter-trigger": {
            borderStyle: 'dotted',
          },

          "&.column-header-menu-trigger": {
            justifyContent: "space-between",
            marginLeft: `-${themeVars.padding.md}px !important`,
            overflow: "visible",
            boxShadow: "none",
            border: "none",
          },
    ...
    MuiSvgIcon: {
      styleOverrides: {
        root: {
          ...
          "&.ts-dt-dynamic-filter-remove-icon:hover": {
            color: 'maroon'
          }
        },
      },
  ...
  typography: {
    fontFamily: `${themeVars.fontFamily} !important`,
    fontSize: themeVars.fontSize,
  },
})
